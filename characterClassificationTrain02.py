# -*- coding: utf-8 -*-
"""
Created on Thu Jul 12 20:41:53 2018
...
def characterClassificationNet(x_image):
    ...
    W_fc3 = tf.Variable(tf.truncated_normal([1024, NUM_CLASSES], stddev=0.1))
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--model_dir',
        type = str,
        default = r'F:\licensePlateRecognition\saveModel\save_72_02', #保存目录
        help = 'Path to folder to save tfrecord.'
    )
    '''
